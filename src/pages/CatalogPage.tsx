...
const categories: Category[] = [
  ...
  { id:'modular', title:'Модульные системы', desc:'До 7 модулей в одной рамке', products:[
    { name:'Милланта модульная', desc:'Гибкая система до 7 модулей.', features:['До 7 модулей','Выключатели, розетки, диммеры, ТВ'], colors:'Различные', img:images.modular.millanta, tag:'Модуль' },
    { name:'Каре модульная', desc:'Квадратный модульный дизайн.', features:['Квадратный дизайн','Совместимость модулей'], colors:'Различные', img:images.modular.kare },
  ]},
  { id:'ext', title:'Удлинители и аксессуары', desc:'Удлинители, вилки, тройники, адаптеры', products:[
    { name:'Групп Приз', desc:'Удлинители различной длины.', features:['С заземлением','Выключатель','Защита от перегрузки'], colors:'Белый', img:images.accessories.extensions },
  ...
  { id:'panels', title:'Электрощиты и автоматика', desc:'Щиты, автоматы, счётчики', products:[
    { name:'Электрощиты', desc:'Для внутренней и наружной установки.', features:['Различные размеры','ДИН-рейка'], colors:'Белый', img:images.panels.boards },
    { name:'Автоматы и УЗО', desc:'Защита электрических цепей.', features:['Автоматы','УЗО','Дифавтоматы'], colors:'Стандарт', img:images.panels.breakers },
    { name:'Счётчики', desc:'Электронные счётчики и контроллеры.', features:['Высокая точность','ДИН-рейка'], colors:'Стандарт', img:images.panels.meters },
  ]},
  { id:'special', title:'Диммеры и спецсерия', desc:'Светорегуляторы, карточные выключатели', products:[
    { name:'Диммеры', desc:'Плавная регулировка яркости.', features:['Для всех типов ламп','Поворотный механизм'], colors:'Под серию', img:images.special.dimmers },
    { name:'Карточные выключатели', desc:'Для отелей и гостиниц.', features:['Активация по карте','Экономия энергии'], colors:'Белый, серебро', img:images.special.hotelCards, tag:'Для отелей' },
  ]},
];
